<template>
  <div>
    ...
    <div style="background: #151720" class="navbarWrap fixed z-20">
      <div
        class="navbar flex flex-col shrink-0 w-40 lg:w-64 md:w-56 ml-0 lg:ml-36 p-4 select-none"
      >
        <div class="navMob flex items-center justify-between mb-5">
          <div
            @click="showNav = !showNav"
            class="menuIcon cursor-pointer shrink-0"
          >
            <svg
              v-if="!showNav"
              clip-rule="evenodd"
              ...
              >
                <div v-for="server in server">
                  ...
                  >
                    ...
                    <img
                      v-else
                      :src="require(`@/assets/img/${server.icon}`)"
                      alt="server logo"
                    />
        ...
        <transition appear name="nav" mode="out-in">
          ...
          >
            <NuxtLink
              :to="'/dashboard?id=' + this.$route.query.id"
              class="nav_item"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <NuxtLink
              :to="'/dashboard/members?id=' + this.$route.query.id"
              class="nav_item"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <NuxtLink
              :to="'/dashboard/invite?id=' + this.$route.query.id"
              class="nav_item"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <NuxtLink
              :to="'/dashboard/verify?id=' + this.$route.query.id"
              class="nav_item"
            >
              <svg
                width="24"
            ...
            <a
              href="https://nguard.xyz/upgrade"
              target="_blank"
              class="nav_item nav_item_premium"
            >
...
export default {
  ...
  data() {
    return {
      showMenu: false,
      server: [{ name: '불러오는 중...', icon: 'test.png' }],
      showNav: true,
      isMobile: false,
    }
  },
