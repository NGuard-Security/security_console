...
onMounted(() => {
  if (!getAccessToken()) {
    const login = `https://discord.com/api/oauth2/authorize?client_id=937636597040570388&redirect_uri=${window.location.origin}/auth/callback&response_type=code&scope=identify guilds guilds.join email&state=${i18n.locale}`
